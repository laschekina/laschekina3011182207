...
class Mairie
{
    ...
    /**
     * @ORM\Column(name="remise_epci", type="string", length=5, nullable=true)
     */
    private $remiseEpci;

    /**
     * @ORM\Column(name="remise_association_epci", type="string", length=5, nullable=true)
     */
    private $remiseAssociationEpci;

    /**
     * @ORM\Column(name="comptable", type="string", length=15, nullable=false)
     */
    private $comptable;
     ...
     * Set remiseEpci
     *
     * @param string $remiseEpci
     *
     * @return Mairie
     */
    public function setRemiseEpci($remiseEpci)
    {
        $this->remiseEpci = $remiseEpci;
     ...
     * @return string
     */
    public function getRemiseEpci()
    {
        return $this->remiseEpci;
    }

    /**
     * Set remiseAssociationEpci
     *
     * @param string $remiseAssociationEpci
     *
     * @return Mairie
     */
    public function setRemiseAssociationEpci($remiseAssociationEpci)
    {
        $this->remiseAssociationEpci = $remiseAssociationEpci;

        return $this;
    }

    /**
     * Get remiseAssociationEpci
     *
     * @return string
     */
    public function getRemiseAssociationEpci()
    {
        return $this->remiseAssociationEpci;
    }
